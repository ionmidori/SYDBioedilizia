...
- **Framework**: Next.js 16.2.11 (App Router) + React 19.2.8 (Turbopack hardened).
...
- **API**: FastAPI 0.139.2 (Python ≥3.12) with high-concurrency **Raw ASGI middleware** stack and native unstructured payload routing.
...
| Layer | Technologies |
| :--- | :--- |
| **Frontend** | Next.js 16.2.11, React 19.2.8, Tailwind CSS 4, Framer Motion 12, SWR, Zod 4, TypeScript 6 |
| **Backend** | Python ≥3.12, FastAPI 0.139.2, Pydantic V2 (Strict Mode), Starlette 1.3, `uv` |
...
### Quality Assurance
- **Backend Tests**: `uv run pytest` — **463** unit tests passing ✅ (ADK 2.x compatible).
...
---
*© 2026 SYD Bioedilizia. All rights reserved. Version: v4.4.6 | Updated: July 23, 2026*
