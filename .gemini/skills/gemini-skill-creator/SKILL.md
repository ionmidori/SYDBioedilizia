...
description: A comprehensive guide and reference for creating best-practice Agent Skills. Consult this skill when authoring new skills or refining existing ones.
---
...
The [context window](/docs/en/build-with-antigravity/context-windows) is a public good. Your Skill shares the context window with everything else Antigravity needs to know, including:
- The system prompt
...
- **Antigravity Haiku** (fast, economical): Does the Skill provide enough guidance?
- **Antigravity Sonnet** (balanced): Is the Skill clear and efficient?
- **Antigravity Opus** (powerful reasoning): Does the Skill avoid over-explaining?
...
- Cannot contain reserved words: "anthropic", "antigravity"
...
- Reserved words: `anthropic-helper`, `antigravity-tools`
...
SKILL.md serves as an overview that points Antigravity to detailed materials as needed, like a table of contents in an onboarding guide. For an explanation of how progressive disclosure works, see [How Skills work](/docs/en/agents-and-tools/agent-skills/overview#how-skills-work) in the overview.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Use Skills in Antigravity Code"
    icon="terminal"
    href="https://code.antigravity.com/docs/en/skills"
  >
    Create and manage Skills in Antigravity Code
  </Card>
  <Card
  ...
  <Card
    ...
    icon="code"
    href="/docs/en/build-with-antigravity/skills-guide"
  >
