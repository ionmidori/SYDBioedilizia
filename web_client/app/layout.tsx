...
export default async function RootLayout({
  ...
  // CSP nonce is generated by middleware.ts and injected via x-nonce header.
  // Currently in Report-Only mode (no blocking). When switching to enforcing
  // mode, read the nonce here and pass it to Script components:
