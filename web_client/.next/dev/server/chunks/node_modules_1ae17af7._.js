...
var GoogleGenerativeAIImageModel = class {
    ...
    async doGenerate(options) {
        ...
        if (files != null && files.length > 0) {
            throw new Error("Google Generative AI does not support image editing. Use Google Vertex AI (@ai-sdk/google-vertex) for image editing capabilities.");
        }
        if (mask != null) {
...
//# sourceMappingURL=node_modules_1ae17af7._.js.map